...
export { default as MelonGLB } from './melon.glb';
export { default as OrangeGLB } from './orange.glb';
export { default as PacmanGLB } from './pacman.glb';
export { default as StarGLB } from './star.glb';
